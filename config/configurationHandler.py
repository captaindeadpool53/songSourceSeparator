class ConfigurationHandler :
	def __init__(self, TRAINING_DATA_ROOT, SAMPLE_RATE, SEGMENT_LENGTH_IN_SECONDS, FRAME_SIZE, HOP_LENGTH,NUMBER_OF_OUTPUT_CHANNELS, SONG_TO_PREDICT_PATH, DICTIONAY_SAVE_PATH) -> None:
