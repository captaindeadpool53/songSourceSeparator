...
class ConfigurationHandler :
	def __init__(self, PROJECT_ROOT_PATH, SAMPLE_RATE, SEGMENT_LENGTH_IN_SECONDS, FRAME_SIZE, HOP_LENGTH,NUMBER_OF_OUTPUT_CHANNELS, BATCH_SIZE) -> None:
		...
		self.SAMPLES_PER_SEGMENT = int(self.SEGMENT_LENGTH * self.SAMPLE_RATE)
		self.FRAMES_IN_SEGMENT = int(1 + (self.SAMPLES_PER_SEGMENT - self.FRAME_SIZE)//self.HOP_LENGTH)
