class ConfigurationHandler :
	def __init__(self, TRAINING_DATA_ROOT, SAMPLE_RATE, SEGMENT_LENGTH_IN_SECONDS, FRAME_SIZE, HOP_LENGTH,NUMBER_OF_OUTPUT_CHANNELS, PREDICTION_DATA_ROOT ) -> None:
		self.TRAINING_DATA_ROOT: str = TRAINING_DATA_ROOT
		self.SAMPLE_RATE: int = SAMPLE_RATE
		self.SEGMENT_LENGTH: float = SEGMENT_LENGTH_IN_SECONDS
		self.FRAME_SIZE: int = FRAME_SIZE
		self.HOP_LENGTH: int = HOP_LENGTH
		self.PREDICTION_DATA_ROOT: str = PREDICTION_DATA_ROOT
